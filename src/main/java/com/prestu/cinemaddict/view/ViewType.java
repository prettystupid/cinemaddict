...
import com.prestu.cinemaddict.view.schedule.ScheduleView;
import com.prestu.cinemaddict.view.transactions.TransactionsView;
...
public enum ViewType {
    ...
    private ViewType(final String viewName, final String caption,
