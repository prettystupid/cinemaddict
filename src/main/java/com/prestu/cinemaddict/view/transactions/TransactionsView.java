package com.prestu.cinemaddict.view.transactions;
...
public final class TransactionsView extends VerticalLayout implements View {
    ...
    private Table buildTable() {
        ...
        table.setContainerDataSource(new TempTransactionsContainer(CinemaddictAppUI
            ...
            if (action == discard) {
                ...
                if (item != null) {
                    Long movieId = (Long) item.getItemProperty("movieId")
                            .getValue();
                    MovieDetailsWindow.open(CinemaddictAppUI.getDataProvider()
