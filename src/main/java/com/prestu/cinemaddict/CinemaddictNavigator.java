...
import com.prestu.cinemaddict.view.ViewType;
...
public class CinemaddictNavigator extends Navigator {
    ...
    public CinemaddictNavigator(final ComponentContainer container) {
